...
async function onLoad() {
  ...
  createPostEventButton.addEventListener('click', showModalEvent);
  ...
  // submitModalEventButton.addEventListener('click', submitModalEvent);
